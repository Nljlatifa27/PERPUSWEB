...
/**
 ...
 Level  : Menengah
 Author : PerpustakaanIbrahimy
 Blog   : www.PerpustakaanIbrahimy.com
 Web    : www.PerpustakaanIbrahimy.com
 Email  : sisteminformasi@gmail.com
 
 Butuh jasa pembuatan website, aplikasi, pembuatan program TA dan Skripsi.? Hubungi Email ==>> sisteminformasi@gmail.com
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $pdf->Ln();
    $pdf->Cell(80);
    $pdf->Cell(30, 10, 'Website PerpustakaanIbrahimy', 0, 0, 'C');
    $pdf->Ln();
}
