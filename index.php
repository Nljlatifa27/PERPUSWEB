...
<head>
    <meta charset="UTF-8">
    <title>Perpustakaan Ibrahimy || Membaca Membuka Wawasan Dunia!</title>
    ...
    <meta name="perpustakaan unib" content="Perpustakaan UNIB" />
    <!-- bootstrap 3.0.2 -->
...
<body class="skin-black">
    ...
    <header class="header">
        <a href="index.html" class="logo">
            Perpustakaan Universitas Ibrahimy
        </a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <b>Selamat Datang di Perpustakaan Universitas Ibrahimy, Untuk Login silahkan klik Icon User atau klik <a href="login.html">disini</a></b> | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
    ...
    <div class="footer-main">
        Copyright Perpustakaan Ibrahimy 2022 | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
    </div>
    </aside><!-- /.right-side -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p> Perpustakaan Ibrahimy adalah salah satu layanan bagi pengguna untuk dapat mengakses berbagai buku bacaan yang dan dilakukan kapan saja dan dari mana saja, dengan menggunakan jaringan internet.</p>
                    <p> Perpustakaan Ibrahimy memiliki koleksi buku dalam bentuk format digital dan bisa diakses dengan komputer. koleksi bacaan dari PerpustakaanKu dapat diakses dengan cepat dan mudah lewat jaringan komputer.</p>
                    <p> Perpustakaan Ibrahimy bebasis website yang responsif, untuk info, saran, maupun kritik bisa menghubungi kami :</p>
                    <table>
                        <tr>
                            <td>E-mail</td>
                            <td>:</td>
                            <td><a href="sisteminformasi@gmail.com">PerpustakaanIbrahimy@gmail.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Blog</td>
                            <td>:</td>
                            <td><a href="#" target="_blank">www.PerpustakaanIbrahimy.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Website</td>
